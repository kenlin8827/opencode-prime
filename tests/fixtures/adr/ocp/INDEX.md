...
*Directory: `tests/fixtures/adr/ocp`*

## Records (1)

| ID | Decision Title | Style | Layer | Status | Domain | Iteration | Created |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [ADR-0.2.54](./0.2.54-commission-calc-mode.md) | Iteration 0.2.54 · Commission dual calc mode (2 sections) | `ocp` | `system` | 🟢 Accepted | commission | 54 | 2026-09-17 |
