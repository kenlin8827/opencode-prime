...
*Directory: `tests/fixtures/adr/mixed-adl`*

## Records (1)

| ID | Decision Title | Style | Layer | Status | Domain | Iteration | Created |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [ADR-0001](./0001-use-postgresql.md) | Use PostgreSQL as the primary database | `madr` | `system` | 🟢 Accepted |  |  | 2026-09-01 |

## Child scopes

| Directory | Records (subtree) | Index |
| :--- | :--- | :--- |
| [domains/billing](domains/billing/INDEX.md) | 1 | `tests/fixtures/adr/mixed-adl/domains/billing/INDEX.md` |
| [domains/commission](domains/commission/INDEX.md) | 3 | `tests/fixtures/adr/mixed-adl/domains/commission/INDEX.md` |
