...
*Directory: `tests/fixtures/adr/legacy`*

## Records (2)

| ID | Decision Title | Style | Layer | Status | Domain | Iteration | Created |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [ADR-0001](./0001-event-driven-sync.md) | Use event-driven sync for cross-service consistency | `madr` | `system` | 🟢 Accepted |  |  | 2026-09-01 |
| [ADR-0002](./0002-idempotent-consumers.md) | Make all event consumers idempotent | `madr` | `domain` | 🔵 Proposed |  |  | 2026-09-05 |
